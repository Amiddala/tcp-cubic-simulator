...
let cwnd = 1, ssthresh = 32, wMax = 32, K = 0;
let phase = 'Slow Start';
let tick = 0, t0 = 0, losses = 0;
let timer = null;
...
const chart = new Chart(document.getElementById('chart'), {
  ...
  data: {
    labels: [],
    datasets: [
      { label: 'cwnd', data: [], borderColor: '#2563eb', fill: false, pointRadius: 0, borderWidth: 2 },
      { label: 'ssthresh', data: [], borderColor: '#dc2626', borderDash: [5,4], fill: false, pointRadius: 0, borderWidth: 1.5 }
    ]
  },
  options: {
    responsive: true,
...
// Algoritmo CUBIC: un paso por RTT
function step() {
  ...
  // Actualizar gráfica (máx 80 puntos)
...
function reset() {
  pause();
  cwnd = 1; ssthresh = 32; wMax = 32; K = 0;
  phase = 'Slow Start'; tick = 0; t0 = 0; losses = 0;
  chart.data.labels = [];
